...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the control-panel-databases public boundary. It
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-control-panel-databases-filament?sort=semver)](https://github.com/liberusoftware/module-control-panel-databases-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-control-panel-databases-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-control-panel-databases-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-control-panel-databases-filament
```
...
<a href="https://github.com/liberusoftware/module-control-panel-databases-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-control-panel-databases-filament" alt="Contributors to liberusoftware/module-control-panel-databases-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-control-panel-databases-filament/graphs/contributors).
